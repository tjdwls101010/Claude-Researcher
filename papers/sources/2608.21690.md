...
generated: {by: save-paper/0.1, at: '2026-09-05T14:49:48Z'}
conversion:
  route: html
  converter: pandoc 3.10; latexml-adapter 0.1
  coverage: 0.9827
  known_losses: ['coverage check failed: 19 block(s) missing']
  ...
  check:
    ...
    missing:
    - {id: abstract1.1, kind: paragraph, preview: LLM agents increasingly take on long-running tasks whose his}
    - {id: footnote#4, kind: footnote, preview: †Equal contribution.}
    - {id: footnote#5, kind: footnote, preview: §Work done during an internship at Alibaba Group.}
    - {id: S3.SS1.SSS0.Px1.p2.1, kind: paragraph, preview: BEAM (27) extends this evaluation to substantially longer co}
    - {id: S4.SS1.SSS0.Px1.p1.1, kind: paragraph, preview: 'Agents do not natively retain information across sessions, s'}
    - {id: S4.T2.2.1.2, kind: cell, preview: LongMemEvalS}
    - {id: S4.T2.2.1.3, kind: cell, preview: BEAM10M}
    - {id: S4.SS1.SSS0.Px1.p2.1, kind: paragraph, preview: 'As shown in Table 2, Scroll is competitive with the stronges'}
    - {id: S4.SS2.p2.1, kind: paragraph, preview: 'Every backbone can use Scroll, but stronger models benefit m'}
    - {id: S4.T4.2.1.2, kind: cell, preview: LongMemEvalS}
    - {id: S4.T4.2.1.3, kind: cell, preview: BEAM10M}
    - {id: S4.SS3.p1.1, kind: paragraph, preview: We ablate the core components of Scroll on BEAM10M. Figure 3}
    - {id: S4.SS4.p1.1, kind: paragraph, preview: Scroll exposes only a small fraction of the corpus to the mo}
    - {id: caption#272, kind: caption, preview: 'Table 5: Per-question-type accuracy (%) of Scroll on LongMem'}
    - {id: A1.T5.6.1.2, kind: cell, preview: LongMemEvalS}
    - {id: A1.T5.6.1.3, kind: cell, preview: LongMemEvalM}
    - {id: A1.SS2.p1.1, kind: paragraph, preview: Table 6 breaks BEAM10M down by memory ability. We compare ag}
    - {id: caption#299, kind: caption, preview: 'Table 6: Per-category judge scores on BEAM10M. Categories fo'}
    - {id: A4.p1.1, kind: paragraph, preview: 'This appendix reproduces four trajectories from the BEAM10M '}
---
